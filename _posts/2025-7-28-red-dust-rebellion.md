...
![alt](../assets/images/COIN/RD/2.png)
...
![alt](../assets/images/COIN/RD/4.png)

##### Asset card

การ์ด Asset จะใช้สำหรับการจ่ายทรัพยากรของ <span style="color:#F78D1F; padding:4px; background-color:#FFE2C4; font-weight:500;">CR</span> แทนการ์ด Event และปรับลำดับสิทธิ์ในการเล่น โดยจะถือได้สูงสุด 6 ใบ เมื่อเล่นแล้วให้ทิ่งลงกองทิ้ง ซึ่งกองทิ้งจะกลับเข้ากองจั่วใหม่ตอน Reset Phase ของ Dust Storm เท่านั้น
...
![alt](../assets/images/COIN/RD/5.png)

##### Campaign card

การ์ด Campaign เป็นการ์ดของ <span style="color:#E31A2A; padding:4px; background-color:#FFCCD0; font-weight:500;">RD</span> จะเปิดตั้งแต่ Setup และจะเปิดได้อีกจากการทำ Operation <u>Campaign</u> หรือจากผลของ Event บางอย่างที่ระบุไว้
...
![alt](../assets/images/COIN/RD/3.png)
...
<span style="color:#006AB4; padding:4px; background-color:#CCEAFF; font-weight:500;">MarsGov</span>, <span style="color:#000000; padding:4px; background-color:#DADADA; font-weight:500;">CORP</span>
...
<span style="color:#000000; padding:4px; background-color:#DADADA; font-weight:500;">CORP</span>
...
<span style="color:#006AB4; background-color:#CCEAFF;padding:4px; font-weight:500;">MarsGov</span>, <span style="color:#000000; padding:4px; background-color:#DADADA; font-weight:500;">CORP</span>
...
<span style="color:#F78D1F; padding:4px; background-color:#FFE2C4; font-weight:500;">CR</span>
...
![alt](../assets/images/COIN/RD/6.png)
...
3. **Displaced Population Penalty**: ลดทรัพยากรของ MarsGov 1 หน่วย และ Profit 2 หน่วย ต่อ Marker ประชากรที่อยู่ใน Displaced Population (ปัดเศษลง)
...
1. <span style="color:#006AB4; background-color:#CCEAFF;padding:4px; font-weight:500;">MarsGov</span>: จำนวนประชากรในพื้นที่ที่มี COIN Control และไม่มี Opposition
2. <span style="color:#000000; padding:4px; background-color:#DADADA; font-weight:500;">CORP</span>: 2 หน่วยต่อฐานที่อยู่ใน Labyrinth
3. <span style="color:#E31A2A; padding:4px; background-color:#FFCCD0; font-weight:500;">RD</span>: จำนวนประชากรในพื้นที่ที่ Active Opposition + จำนวนฐาน
4. <span style="color:#F78D1F; padding:4px; background-color:#FFE2C4; font-weight:500;">CR</span>: จั่วการ์ด Asset 1 ใบสำหรับทุกสัญลักษณ์การ์ดที่บอกใน Available Bases หลังจากนั้นทิ้งการ์ดให้เหลือบนมือ 6 ใบ
...
2. ปรับกองกำลัง โดยห้ามเปลี่ยน Control จนกว่าทุกฝ่ายจะปรับกองกำลังเสร็จ
   ...
   2. <span style="color:#006AB4; background-color:#CCEAFF;padding:4px; font-weight:500;">MarsGov</span>: ย้ายทหารจาก Deserts ที่ไม่มีฐาน COIN ไปยังที่มีฐาน COIN หรือ COIN Control ได้
   3. <span style="color:#E31A2A; padding:4px; background-color:#FFCCD0; font-weight:500;">RD</span>: ย้าย Rebels จาก Deserts ที่ไม่มี Opposition หรือฐาน ไปยังพื้นที่ที่มีฐาน
   4. <span style="color:#F78D1F; padding:4px; background-color:#FFE2C4; font-weight:500;">CR</span>: สามารถย้ายฐานไปยัง Wilderness ได้ โดยต้องพลิก Conversion Center ที่ถูกย้ายกลับด้านที่ยังไม่ได้อัปเกรด จากนั้นสามารถย้าย Rebels ไปยังพื้นที่ที่มีฐานได้
...
<span style="color:#006AB4; background-color:#CCEAFF;padding:4px; font-weight:500;">MarsGov</span>
...
<span style="color:#E31A2A; padding:4px; background-color:#FFCCD0; font-weight:500;">RD</span>
